...
public class OldStageDataManager : MonoBehaviour
{
    public OldStageData[] stageDatas;
    ...
    public List<OldEnemy> CurrentStageEnemyList { get; set; }
    ...
    public OldStageData this[uint index]
    {
    ...
    public void LoadStage(uint stageIndex)
    {
        ...
        OldGameManager.Instance.SlotVisualizer.Initialize();
    }
